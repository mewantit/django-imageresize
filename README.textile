...
Django-imagemagick is an extension to the Django web framework that lets you resize images on server side just by specifying the size in the url. If you want to resize an image, @foo.png@, to 100x100 you simply just use the url @foo.100x100.png@ which makes it very easy to create for example thumbnails. The benefits of django-imagemagick are:
